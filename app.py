...
# + Local GenAI + Automated Incident Response
# ============================================================
...
# n8n webhook will be added later.
#
# Example:
# export SENTINEL_N8N_WEBHOOK="http://localhost:5678/webhook/sentinel"
#
N8N_WEBHOOK_URL = os.getenv(
    "SENTINEL_N8N_WEBHOOK",
    ""
)
...
# ============================================================
# LOCAL LLAMA THREAT INTELLIGENCE
# ============================================================
...
def get_ai_analysis(
    ...
    prompt = f"""
You are ORACLE, the cybersecurity threat analyst inside
SENTINEL AI.

The classification below has already been generated by the
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "You are ORACLE, a concise cybersecurity "
                        "threat analyst. Follow the user's output "
                        "format exactly and never invent evidence."
                    )
                },
                {
                    "role": "user",
...
<span class="badge {ollama_badge_class}">
{ollama_badge_text}
</span>
...
{html.escape(stage["description"])}
        ...
        st.markdown(
            "## Oracle // Local AI Threat Intelligence"
        )
...
<div class="ledger-right">
Grounded intelligence generated locally
</div>
...
<span class="module-description">
Local Llama 3.1 8B produces grounded security intelligence
</span>
